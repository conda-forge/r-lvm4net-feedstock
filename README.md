...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-lvm4net-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14773&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-lvm4net-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-lvm4net` can be installed with:

```
conda install r-lvm4net
```

It is possible to list all of the versions of `r-lvm4net` available on your platform with:
